...
$karya = query("SELECT * FROM karya");
 if (isset($_POST["karya"])){
    if(tambah_data_karya($_POST) > 0){
        echo"
             <script>
                 alert('data berhasil ditambahkan');
                 document.location.href = 'karyadata.php';
             </script>
         ";
    }else{
         echo"
...
if(isset($_POST['cari'])){
  $karya = cari_karya($_POST["keyword"]);
}
...
<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">karya</h5>
        ...
        <div class="modal-body">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" name="karya" class="btn btn-dark">Kirim</button>
            </div>
        </form>
    </div>
</div>
...
<section class="container">
  ...
  <!-- Modal -->
  <div class="modal fade" id="modal<?= $kar['id']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel"
  aria-hidden="true">
  <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-dark" data-bs-dismiss="modal">Batal</button>
          <button type="submit" name="edit_karya" class="btn btn-dark">Kirim</button>
        </div>
        <?php endforeach ?>
      </form>
    </div>
